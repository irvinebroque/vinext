...
// ---------------------------------------------------------------------------
// vinext:d1 — generated D1 application-object database clients
// ---------------------------------------------------------------------------
//
// Generated by vinext at build time from the `d1` option in the vinext()
// plugin config. Named exports are emitted for each configured database at
// runtime; the default export provides a static fallback type for dynamic access.

declare module "vinext:d1" {
  import type { VinextD1DatabaseClient } from "vinext/cloudflare/d1";

  const databases: Record<string, VinextD1DatabaseClient>;
  export default databases;
}

declare module "virtual:vinext-d1-objects" {}
